    ...
    <div className="empty-state">
      <div className="empty-state-content">
        ...
        <p className="empty-sub">
          Upload PDFs and ask questions — powered by LangChain RAG and local HuggingFace models. No API key needed.
        </p>
        <button className="empty-cta" onClick={onCreate}>
          Start a new session
        </button>
        <div className="tech-badges">
          {["Flask", "LangChain", "HuggingFace", "FAISS", "MySQL", "React"].map((t) => (
